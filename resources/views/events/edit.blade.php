    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('events.update', $event) }}" x-data="{
                ...
                enctype="multipart/form-data" class="p-4 bg-white rounded-md">
                @csrf
                @method('PUT')
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="num_tickets"
                            class="block mb-2 text-sm font-medium text-gray-900">Nr: Tickets</label>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ $event->description }}</textarea>
                        @error('description')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div>
                    <h3 class="mb-4 font-semibold text-gray-900">Tags</h3>
                    <ul
